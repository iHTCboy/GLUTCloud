...
- (void)configBottomPanel
{
    ...
    _bottomPanel = [[UIView alloc] initWithFrame:
                    CGRectMake(0, self.view.height - kBottomPaneHeight, self.view.frame.size.width, kBottomPaneHeight)];
    ...
    routeBtn.frame = CGRectMake(self.view.frame.size.width - 100, 15, 70, 30);
