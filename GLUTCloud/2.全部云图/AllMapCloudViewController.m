//
//  AllMapCloudViewController.m
//  GLUTCloud
//
//  Created by HTC on 14-12-30.
...
#define GeoPlaceHolder @"云图搜索"

@interface AllMapCloudViewController()<UISearchBarDelegate, UISearchDisplayDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation AllMapCloudViewController
...
- (void)cloudPlaceLocalSearchWithKey:(NSString *)key
{
    ...
    [placeLocal setTableID:(NSString *)allTableID];
...
- (void)cloudPlaceAroundSearch
{
    ...
    [placeAround setTableID:(NSString *)allTableID];
    ...
    //AMapCloudPoint * centerPoint = [AMapCloudPoint locationWithLatitude:25.063072 longitude:110.303577];
